  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-4 py-16 text-center">
        <h1
          className="text-[32px] md:text-[40px] font-medium tracking-[-0.02em] leading-tight text-foreground"
        >
          A calm place to work through a difficult conversation.
        </h1>
        <p className="mt-4 text-lg text-muted-foreground max-w-md">
          Clarity guides you and the other person toward resolution — privately, at your own pace.
        </p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-sm text-muted-foreground">Work through your thoughts with AI guidance before sharing.</p>
          </div>
          <div className="flex flex-col items-center gap-3">
            <Users className="h-8 w-8 text-muted-foreground" aria-hidden="true" />
            <h3 className="font-medium text-foreground">Shared Conversation</h3>
            <p className="text-sm text-muted-foreground">Come together when both sides are ready to talk.</p>
          </div>
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-sm text-muted-foreground">Reach understanding with structured support.</p>
          </div>
        </div>
      </section>
